...
class PaletteTableViewCell: UITableViewCell {
    ...
    // MARK: - Add Subviews to the cell (Step 2)
    ...
    // MARK: - Constrain our views (Step 3)
    ...
    func setUpViews() {
        ...
        colorPaletteView.anchor(top: paletteTitleLabel.bottomAnchor, bottom: contentView.bottomAnchor, leading: contentView.leadingAnchor, trailing: contentView.trailingAnchor, topPadding: SpacingConstants.verticalObjectBuffer, bottomPadding: SpacingConstants.outerVerticalPadding, leadingPadding: SpacingConstants.outerVerticalPadding, trailingPadding: SpacingConstants.outerVerticalPadding, width: nil, height: SpacingConstants.twoLineElementHeight)
